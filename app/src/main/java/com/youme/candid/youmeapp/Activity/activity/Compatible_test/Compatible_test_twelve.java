...
public class Compatible_test_twelve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compatible_test_twelve);
    ...
    private void init() {
        ...
        radioButton_yes = (RadioButton) findViewById(R.id.c_twelve_yes);
        radioButton_no = (RadioButton) findViewById(R.id.c_twelve_no);
        img_nxt = (ImageView) findViewById(R.id.ctesttwelve_next_step);
        img_previous = (ImageView) findViewById(R.id.ctesttwelve_previous_step);
        ...
        System.out.println("test 11"+ test_twelve);
        if (test_twelve!=null) {
            if (test_twelve.equalsIgnoreCase("Yes")) {
                radioButton_yes.setChecked(true);
            } else if (test_twelve.equalsIgnoreCase("No")) {
    ...
    private void click() {
        ...
        img_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_TWELVE, "Yes");
                        startActivity(new Intent(Compatible_test_twelve.this, Compatible_test_thirteen.class));
                    }
                    else if(radioButton_no.isChecked()==true)
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_TWELVE, "No");
                        startActivity(new Intent(Compatible_test_twelve.this, Compatible_test_thirteen.class));
                    }
                }
                // updateData();
        ...
        img_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Compatible_test_twelve.this, Compatible_test_eleven.class));
            }
        });
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (Status.equals("success")) {
                                ...
                                startActivity(new Intent(Compatible_test_twelve.this, MyProfileActiivty.class));
