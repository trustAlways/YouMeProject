...
public class Compatible_test_seven extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compatible_test_seven);
    ...
    private  void init(){
        ...
        radioButton_yes = (RadioButton)findViewById(R.id.c_seven_yes);
        radioButton_no = (RadioButton)findViewById(R.id.c_seven_no);
        img_nxt = (ImageView)findViewById(R.id.ctestseven_next_step);
        img_previous = (ImageView)findViewById(R.id.ctestseven_previous_step);
        btn_reset_txtview = (TextView)findViewById(R.id.reset_btn);

         String test_seven = sessionManager.getData(SessionManager.KEY_COMPATIBILITY_SEVEN);
         System.out.println(" test 7" + test_seven);

         if (test_seven != null) {

            if (test_seven.equalsIgnoreCase("Practical")) {
                radioButton_yes.setChecked(true);
            } else if (test_seven.equalsIgnoreCase("Creative")) {
    ...
    private void click() {
        ...
        img_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_SEVEN,"Practical");
                        startActivity(new Intent(Compatible_test_seven.this, Compatible_test_eight.class));
                    }
                    else if(radioButton_no.isChecked()==true)
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_SEVEN,"Creative");
                        startActivity(new Intent(Compatible_test_seven.this, Compatible_test_eight.class));
                    }
                }
            }
        ...
        img_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Compatible_test_seven.this, Compatible_test_six.class));
            }
        });
