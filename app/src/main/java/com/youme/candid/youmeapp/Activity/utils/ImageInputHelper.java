...
public class ImageInputHelper {
        ...
        public void takePhotoWithCamera() {
            ...
            if (tempFileFromSource == null) {
                ...
                //tempFileFromSource = new File(Environment.getExternalStorageDirectory() + "/DCIM/", "image" + new Date().getTime() + ".png");
                //tempUriFromSource = FileProvider.getUriForFile(mContext, "com.youme.candid.youmeapp.fileprovider", tempFileFromSource/*"com.sample.test.fileprovider",file*/);/* Uri.fromFile(file);*/
