...
public class Compatible_test_eleven extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compatible_test_eleven);
    ...
    private void init() {
        ...
        radioButton_yes = (RadioButton) findViewById(R.id.c_eleven_yes);
        radioButton_no = (RadioButton) findViewById(R.id.c_eleven_no);
        img_nxt = (ImageView) findViewById(R.id.ctesteleven_next_step);
        img_previous = (ImageView) findViewById(R.id.ctesteleven_previous_step);
        btn_reset_txtview = (TextView)findViewById(R.id.reset_btn);


        final String test_eleven = sessionManager.getData(SessionManager.KEY_COMPATIBILITY_ELEVEN);
        System.out.println("test 11"+ test_eleven);
        if (test_eleven!=null) {
            if (test_eleven.equalsIgnoreCase("Yes")) {
                radioButton_yes.setChecked(true);
            } else if (test_eleven.equalsIgnoreCase("No")) {
    ...
    private void click() {
        ...
        img_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_ELEVEN, "Yes");
                        startActivity(new Intent(Compatible_test_eleven.this, Compatible_test_twelve.class));
                    }
                    else if(radioButton_no.isChecked()==true)
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_ELEVEN, "No");
                        startActivity(new Intent(Compatible_test_eleven.this, Compatible_test_twelve.class));
                    }
                }
        ...
        img_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Compatible_test_eleven.this, Compatible_test_ten.class));
            }
        });
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (Status.equals("success")) {
                                ...
                                startActivity(new Intent(Compatible_test_eleven.this, MyProfileActiivty.class));
