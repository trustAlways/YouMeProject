...
public class Compatible_test_fourteen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compatible_test_fourteen);
    ...
    private void init() {
        ...
        radioButton_yes = (RadioButton) findViewById(R.id.c_fourteen_yes);
        radioButton_no = (RadioButton) findViewById(R.id.c_fourteen_no);
        img_nxt = (ImageView) findViewById(R.id.ctestfourteen_next_step);
        img_previous = (ImageView) findViewById(R.id.ctestfourteen_previous_step);
        ...
        System.out.println("test 14"+ test_fourteen);
        if (test_fourteen!=null) {
            if (test_fourteen.equalsIgnoreCase("Yes")) {
                radioButton_yes.setChecked(true);
            } else if (test_fourteen.equalsIgnoreCase("No")) {
    ...
    private void click() {
        ...
        img_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_FOURTEEN, "Yes");
                        startActivity(new Intent(Compatible_test_fourteen.this, Compatible_test_fifteen.class));
                    }
                    else if(radioButton_no.isChecked()==true)
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_FOURTEEN, "No");
                        startActivity(new Intent(Compatible_test_fourteen.this, Compatible_test_fifteen.class));
                    }
                }
                // updateData();
        ...
        img_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Compatible_test_fourteen.this, Compatible_test_thirteen.class));
            }
        });
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (Status.equals("success")) {
                                ...
                                startActivity(new Intent(Compatible_test_fourteen.this, MyProfileActiivty.class));
