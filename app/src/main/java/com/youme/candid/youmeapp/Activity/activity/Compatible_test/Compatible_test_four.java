...
public class Compatible_test_four extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compatible_test_four);
    ...
    private  void init(){
        ...
        radioButton_yes = (RadioButton)findViewById(R.id.c_four_yes);
        radioButton_no = (RadioButton)findViewById(R.id.c_four_no);
        img_nxt = (ImageView)findViewById(R.id.ctestfour_next_step);
        img_previous = (ImageView)findViewById(R.id.ctestfour_previous_step);
        ...
        System.out.println(" test 4" + test_four);

        if (test_four!=null) {
            if (test_four.equalsIgnoreCase("Yes")) {
                radioButton_yes.setChecked(true);
            } else if (test_four.equalsIgnoreCase("No")) {
    ...
    private void click() {
        ...
        img_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                  ...
                  {
                    sessionManager.setData(SessionManager.KEY_COMPATIBILITY_FOUR,"Yes");
                    startActivity(new Intent(Compatible_test_four.this, Compatible_test_five.class));
                  }
                    else if (radioButton_no.isChecked()==true)
                  {
                    sessionManager.setData(SessionManager.KEY_COMPATIBILITY_FOUR,"No");
                    startActivity(new Intent(Compatible_test_four.this, Compatible_test_five.class));
                  }
        ...
        img_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Compatible_test_four.this, Compatible_test_three.class));
            }
        });
