...
public class Compatible_test_nine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compatible_test_nine);
    ...
    private  void init(){
        ...
        radioButton_yes = (RadioButton)findViewById(R.id.c_nine_yes);
        radioButton_no = (RadioButton)findViewById(R.id.c_nine_no);
        img_nxt = (ImageView)findViewById(R.id.ctestnine_next_step);
        img_previous = (ImageView)findViewById(R.id.ctestnine_previous_step);
        ...
        System.out.println(" test 9" + test_nine);

        if (test_nine != null) {
            if (test_nine.equalsIgnoreCase("Yes")) {
                radioButton_yes.setChecked(true);
            } else if (test_nine.equalsIgnoreCase("No")) {
    ...
    private void click() {
        ...
        img_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_NINE,"Yes");
                        startActivity(new Intent(Compatible_test_nine.this, Compatible_test_ten.class));
                    }
                    else if(radioButton_no.isChecked()==true)
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_NINE,"no");
                        startActivity(new Intent(Compatible_test_nine.this, Compatible_test_ten.class));
                    }
                }
        ...
        img_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Compatible_test_nine.this, Compatible_test_eight.class));
            }
        });
