...
public class Compatible_test_seventy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compatible_test_seventeen);
    ...
    private void init() {
        ...
        radioButton_yes = (RadioButton) findViewById(R.id.c_seventeen_yes);
        radioButton_no = (RadioButton) findViewById(R.id.c_seventeen_no);
        img_nxt = (ImageView) findViewById(R.id.ctestseventy_next_step);
        img_previous = (ImageView) findViewById(R.id.ctestseventy_previous_step);
        ...
        System.out.println("test 17"+ test_seventeen);
        if (test_seventeen!=null) {
            if (test_seventeen.equalsIgnoreCase("Yes")) {
                radioButton_yes.setChecked(true);
            } else if (test_seventeen.equalsIgnoreCase("No")) {
    ...
    private void click() {
        ...
        img_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_SEVENTEEN, "Yes");
                        startActivity(new Intent(Compatible_test_seventy.this, Compatible_test_eighty.class));
                    }
                    else if(radioButton_no.isChecked()==true)
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_SEVENTEEN, "No");
                        startActivity(new Intent(Compatible_test_seventy.this, Compatible_test_eighty.class));
                    }
                }
                // updateData();
        ...
        img_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Compatible_test_seventy.this, Compatible_test_sixteen.class));
            }
        });
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (Status.equals("success")) {
                                ...
                                startActivity(new Intent(Compatible_test_seventy.this, MyProfileActiivty.class));
