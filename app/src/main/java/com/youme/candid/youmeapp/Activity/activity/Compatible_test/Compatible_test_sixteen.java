...
public class Compatible_test_sixteen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compatible_test_sisxteen);
    ...
    private void init() {
        ...
        radioButton_yes = (RadioButton) findViewById(R.id.c_sixty_yes);
        radioButton_no = (RadioButton) findViewById(R.id.c_sixty_no);
        img_nxt = (ImageView) findViewById(R.id.ctestsixty_next_step);
        img_previous = (ImageView) findViewById(R.id.ctestsixty_previous_step);
        ...
        System.out.println("test 16"+ test_sixteen);
        if (test_sixteen!=null) {
            if (test_sixteen.equalsIgnoreCase("Yes")) {
                radioButton_yes.setChecked(true);
            } else if (test_sixteen.equalsIgnoreCase("No")) {
    ...
    private void click() {
        ...
        img_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_SIXTEEN, "Yes");
                        startActivity(new Intent(Compatible_test_sixteen.this, Compatible_test_seventy.class));
                    }
                    else if(radioButton_no.isChecked()==true)
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_SIXTEEN, "No");
                        startActivity(new Intent(Compatible_test_sixteen.this, Compatible_test_seventy.class));
                    }
                }
                // updateData();
        ...
        img_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Compatible_test_sixteen.this, Compatible_test_fifteen.class));
            }
        });
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (Status.equals("success")) {
                                ...
                                startActivity(new Intent(Compatible_test_sixteen.this, MyProfileActiivty.class));
