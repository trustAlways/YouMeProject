...
public class Compatible_test_thirteen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compatible_test_thiteen);
    ...
    private void init() {
        ...
        radioButton_yes = (RadioButton) findViewById(R.id.c_thireteen_yes);
        radioButton_no = (RadioButton) findViewById(R.id.c_thireteen_no);
        img_nxt = (ImageView) findViewById(R.id.ctestthireteen_next_step);
        img_previous = (ImageView) findViewById(R.id.ctestthireteen_previous_step);
        ...
        System.out.println("test 13"+ test_thrteen);
        if (test_thrteen!=null) {
            if (test_thrteen.equalsIgnoreCase("Public Places")) {
                radioButton_yes.setChecked(true);
            } else if (test_thrteen.equalsIgnoreCase("Social Media")) {
    ...
    private void click() {
        ...
        img_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_THIRTEEN, "Public Places");
                        startActivity(new Intent(Compatible_test_thirteen.this, Compatible_test_fourteen.class));
                    }
                    else if(radioButton_no.isChecked()==true)
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_THIRTEEN, "Social Media");
                        startActivity(new Intent(Compatible_test_thirteen.this, Compatible_test_fourteen.class));
                    }
                }// updateData();
            }
        ...
        img_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Compatible_test_thirteen.this, Compatible_test_twelve.class));
            }
        });
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (Status.equals("success")) {
                                ...
                                startActivity(new Intent(Compatible_test_thirteen.this, MyProfileActiivty.class));
