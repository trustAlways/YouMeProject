...
public class Compatible_test_three extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compatible_test_three);
    ...
    private  void init(){
        ...
        radioButton_yes = (RadioButton)findViewById(R.id.c_three_yes);
        radioButton_no = (RadioButton)findViewById(R.id.c_three_no);
        img_nxt = (ImageView)findViewById(R.id.ctestthree_next_step);
        img_previous = (ImageView)findViewById(R.id.ctestthree_previous_step);
        ...
        System.out.println(" test 3" + test_three);

        if (test_three!=null) {
            if (test_three.equalsIgnoreCase("Yes")) {
                radioButton_yes.setChecked(true);
            } else if (test_three.equalsIgnoreCase("No")) {
    ...
    private void click() {
        ...
        img_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_THREE,"Yes");
                        startActivity(new Intent(Compatible_test_three.this, Compatible_test_four.class));
                    }
                       else if (radioButton_no.isChecked()==true)
                    {
                         sessionManager.setData(SessionManager.KEY_COMPATIBILITY_THREE,"No");
                         startActivity(new Intent(Compatible_test_three.this, Compatible_test_four.class));
                    }
               }
        ...
        img_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Compatible_test_three.this, Compatible_test_two.class));
            }
        });
