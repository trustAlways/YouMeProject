...
public class Compatible_test_fifteen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.compatible_test_fifty);
    ...
    private void init() {
        ...
        radioButton_yes = (RadioButton) findViewById(R.id.c_fifty_yes);
        radioButton_no = (RadioButton) findViewById(R.id.c_fifty_no);
        img_nxt = (ImageView) findViewById(R.id.ctestfifty_next_step);
        img_previous = (ImageView) findViewById(R.id.ctestfifty_previous_step);
        ...
        System.out.println("test 15"+ test_fifteen);
        if (test_fifteen!=null) {
            if (test_fifteen.equalsIgnoreCase("Yes")) {
                radioButton_yes.setChecked(true);
            } else if (test_fifteen.equalsIgnoreCase("No")) {
    ...
    private void click() {
        ...
        img_nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_FIFTEEN, "Yes");
                        startActivity(new Intent(Compatible_test_fifteen.this, Compatible_test_sixteen.class));
                    }
                    else if(radioButton_no.isChecked()==true)
                    {
                        sessionManager.setData(SessionManager.KEY_COMPATIBILITY_FIFTEEN,"No");
                        startActivity(new Intent(Compatible_test_fifteen.this, Compatible_test_sixteen.class));
                    }
                }
                // updateData();
        ...
        img_previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Compatible_test_fifteen.this, Compatible_test_fourteen.class));
            }
        });
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (Status.equals("success")) {
                                ...
                                startActivity(new Intent(Compatible_test_fifteen.this, MyProfileActiivty.class));
